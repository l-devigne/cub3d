...
/*   Updated: 2025/09/02 20:24:35 by meruem           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_forward(t_data *data)
{
	...
	temp_new_x = data->player->x + data->player->dir_x * 0.50;
	temp_new_y = data->player->y + data->player->dir_y * 0.50;
...
void	move_left(t_data *data)
{
	...
	temp_new_x = data->player->x - (-data->player->dir_y) * 0.50;
	temp_new_y = data->player->y - data->player->dir_x * 0.50;
	if (!move_to_wall(data, temp_new_x, temp_new_y))
	{
		printf("new x is %f and new y is %f\n", data->player->x, data->player->y);
